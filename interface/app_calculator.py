import sys
from PyQt5.QtWidgets import QMainWindow, QPushButton, QWidget, QGridLayout, QLineEdit, QSizePolicy
...
class Calculator(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.add_btn(
            ...
            lambda: self.display.setText(''),
            'background: #8FBC8F; color: #fff; font-weight: 700;'
        )
        ...
        self.add_btn(
            QPushButton('='), 4, 2, 1, 1,
            self.eval_igual,
            'background: #008080; color: #fff; font-weight: 700;'
        )
